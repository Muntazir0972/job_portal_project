                        ...
                        <div class="card-body card-form p-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6  mb-4">
                                    ...
                                    <select name="category" id="category" class="form-control">
                                        ...
                                        <option {{ ($job->category_id == $category->id) ? 'selected' : '' }} value="{{
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <select class="form-select" name="jobType" id="jobType">
                                        ...
                                        <option {{ ($job->job_type_id == $jobType->id) ? 'selected' : '' }} value="{{
                                            $jobType->id }}">{{ $jobType->name }}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                    <p></p>
                                ...
                                <div class="col-md-6  mb-4">
                                    ...
                                    <input type="number" value="{{ $job->vacancy }}" min="1" placeholder="Vacancy"
                            ...
                            <div class="row">
                                ...
                                <div class="mb-4 col-md-6">
                                    ...
                                    <input type="text" value="{{ $job->location }}" placeholder="Location" id="location"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" value="{{ $job->keywords }}" placeholder="keywords" id="keywords"
